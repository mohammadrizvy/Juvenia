...
export function TestimonialsVariant1() {
  ...
  return (
    <div className="w-full  dark:bg-neutral-900 rounded-2xl mt-10 mb-10 p-8 overflow-hidden ">
      ...
      <div className="flex gap-2 justify-end">
        ...
        >
          <ArrowLeftIcon className="group-disabled:stroke-neutral-500/40 stroke-black transition-colors transform-gpu" />
        </button>
        <button
          ...
          className="rounded-full group size-7 p-1.5 bg-white dark:bg-neutral-950  inline-flex items-center justify-center"
        >
          <ArrowRightIcon className="group-disabled:stroke-neutral-500/40 stroke-black transition-colors transform-gpu" />
        </button>
      </div>
