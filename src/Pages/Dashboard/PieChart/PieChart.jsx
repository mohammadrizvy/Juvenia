...
// Sample data representing most selling products
const data = [
  { name: 'Pants', value: 800 },
  { name: 'Hoodie', value: 300 },
    ...
    return (
      <div className="text-center">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <RechartsPieChart>
            <Pie
              ...
              innerRadius={60}
              outerRadius={80}
              fill="#04A490" // Using the primary color
              dataKey="value"
        ...
        <p className="text-sm text-gray-600 mt-4">
          This chart provides a breakdown of the most selling products based on the sales volume. 
          The data highlights the top-performing products in terms of units sold.
        </p>
      </div>
    );
  }
